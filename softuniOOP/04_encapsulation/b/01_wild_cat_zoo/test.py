# The Animal class is a base class for any type of animal in the zoo. Upon initialization, it should receive four public attributes: a name (string), a gender (str), an age (int), and a money_for_care (int). The Animal class should also have 1 additional method:
