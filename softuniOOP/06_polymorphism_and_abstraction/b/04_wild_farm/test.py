...
#   • Bird - should inherit from the Animal class. The class should be abstract and
#       should have wing_size (float) as an additional attribute passed upon initialization.
...
#   • Owl - "Hoot Hoot"    • Hen - "Cluck"    • Mouse - "Squeak"    • Dog - "Woof!"    • Cat - "Meow"    • Tiger - "ROAR!!!"
# Now use the classes that you have created to instantiate some animals and feed them.
# Add method feed(food) where the food will be an instance of some food classes.  Animals will only eat a specific type of food, as follows:
#   • Hens eat everything
...
#   • Hen - 0.35    • Owl - 0.25    • Mouse - 0.10    • Cat - 0.30    • Dog - 0.40   • Tiger - 1.00
