...
class SearchFrame(Frames):
    ...
    def grid(self) -> None:
        self.frame.grid(row=0, column=0, columnspan=5, sticky="ew")
        self.label.grid(row=0, column=0)
        self.entry.grid(row=0, column=1, sticky="ew")


class CardsFrame(Frames):
    def __init__(self, main: "Main"):
        super().__init__(main)

        # self.list = tk.Listbox(self.frame, bg="grey22", fg="snow")
        #
...
cards_frame_one = CardsFrame(app)
cards_frame_one.grid(1, 0)
cards_frame_one.frame.configure(bg="grey15")

cards_frame_two = CardsFrame(app)
cards_frame_two.grid(1, 2)
cards_frame_two.frame.configure(bg="grey30")

cards_label_one = CardsFrame(app)
cards_label_one.grid(1, 1)
cards_label_one.frame.configure(bg="grey10")

cards_label_two = CardsFrame(app)
cards_label_two.grid(1, 3)
cards_label_two.frame.configure(bg="grey40")
