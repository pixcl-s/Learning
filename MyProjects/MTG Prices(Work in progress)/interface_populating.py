...
def interface_population(list_of_cards):
    ...
    card_colors = []
    for color in list_of_cards.values():
        if not color["colors"]:
            card_colors.append("C")
        elif len(color["colors"]) == 1:
            card_colors.append(color["colors"][0])
        else:
            card_colors.append("Y")
...
#       =============================================== cardkingdom info ===============================================
            ...
            saving_links.append(dict([(0, current_scryfall_url),
                                      (1, current_cardmarket_url),
                                      (3, current_tcgplayer_url),
                                      (5, current_edh_rec_url)]))
